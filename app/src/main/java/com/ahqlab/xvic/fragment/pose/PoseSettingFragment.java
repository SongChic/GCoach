...
import com.ahqlab.xvic.databinding.FragmentPoseSettingBinding;
import com.ahqlab.xvic.domain.CircleProgress;

import java.util.ArrayList;
import java.util.List;

public class PoseSettingFragment extends BaseFragment<PoseSettingFragment> {
    FragmentPoseSettingBinding binding;
    private boolean backState = false;
    String title = "표준 자세 설정";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_pose_setting, container, false);
...
//        Log.e(TAG, String.format("level : %d", level));
    ...
    public static Fragment newInstance() {
        return new PoseSettingFragment();
    }
